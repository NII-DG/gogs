...
import (
	...
	ipfs "github.com/NII-DG/gogs/internal/ipfs"
...
func (m *MockIFIpfsCommand) AddArgs(args ...string) *ipfs.IpfsCommand {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range args {
...
func (m *MockIFIpfsCommand) AddEnvs(envs ...string) *ipfs.IpfsCommand {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range envs {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "AddEnvs", varargs...)
	ret0, _ := ret[0].(*ipfs.IpfsCommand)
	return ret0
}
