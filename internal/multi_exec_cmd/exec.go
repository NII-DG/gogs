package multiexeccmd

//mockファイルの生成
//mockgen -source exec.go -destination mock/mock_exec.go
...
func NewCommand(name string, args ...string) *MultiCommand {
	return &MultiCommand{
		name: name,
		args: args,
	}
}
func (c *MultiCommand) AddArgs(args ...string) {
	c.args = append(c.args, args...)

}
func (c *MultiCommand) RemoveArgs() {
	c.args = []string{}
}

func (c *MultiCommand) AddEnvs(envs ...string) {
	c.envs = append(c.envs, envs...)

}

func (c *MultiCommand) RemoveEnvs() {
	c.envs = []string{}
}

func (c *MultiCommand) RunInDirPipelineWithTimeout(timeout time.Duration, stdout, stderr io.Writer, dir string) (err error) {
...
func (c *MultiCommand) RunInDirWithTimeout(timeout time.Duration, dir string) ([]byte, error) {
...
func (c *MultiCommand) RunInDir(dir string) ([]byte, error) {
...
func (c *MultiCommand) RunWithTimeout(timeout time.Duration) ([]byte, error) {
...
// It returns stdout in string and error (combined with stderr).
func (c *MultiCommand) Run() ([]byte, error) {
